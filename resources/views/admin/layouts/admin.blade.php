    ...
    <div class="container-scroller">
      <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
          ...
          <a class="navbar-brand brand-logo" href="{{ route('admin.index') }}">
              <img src="{{ asset('import/assets/admin/images/logo.jpg') }}" alt="logo" style="width: 40px; height: auto;" />
          </a>

          <a class="navbar-brand brand-logo-mini" href="index.html"><img src="{{ asset('import/assets/admin/images/logo.jpg')}}" alt="logo" /></a>
        </div>
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          <ul class="nav">
            ...
            <li class="nav-item sidebar-actions">
              ...
              <button class="btn-custom btn-lg btn-gradient-primary mt-4">+ Add a project</button>
              </form> --}}<li class="nav-item sidebar-actions">
    <span class="nav-link">
        <form method="POST" action="{{ route('logout') }}">
            @csrf
            <button class="btn btn-block btn-lg" style="background-color: #05ACA3FF; color: #fff;">SignOut</button>
        </form>
    </span>
</li>
